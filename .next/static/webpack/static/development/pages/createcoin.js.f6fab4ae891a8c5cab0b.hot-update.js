webpackHotUpdate("static/development/pages/createcoin.js",{
...
var _jsxFileName = "/Users/david/Dev/myapps/Builders-Log/pages/createcoin.js";
...
function CreateCoin(_id, user) {
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_11___default.a.useState(INITIAL_COIN),
  ...
  react__WEBPACK_IMPORTED_MODULE_11___default.a.useEffect(function () {
    var isCoin = _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_9___default()(record).every(function (el) {
      return Boolean(el);
    });
  ...
  function handleSubmit(event) {
    var mediaUrl, url, year, mint, era, grade, index, payload, response, coinId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            url = "".concat(_utils_baseUrl__WEBPACK_IMPORTED_MODULE_14__["default"], "/api/coin");
            year = record.year, mint = record.mint, era = record.era, grade = record.grade, index = record.index;
            payload = {
              mediaUrl: mediaUrl,
              year: year,
              mint: mint,
          ...
          case 12:
            ...
            next_router__WEBPACK_IMPORTED_MODULE_16___default.a.push("/coin?_id=".concat(coinId));
            _context2.next = 22;
            break;
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_11___default.a.Fragment, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_12__["Header"], {
    ...
    __self: this
  }), "Create a Coin Record"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_12__["Form"], {
    loading: loading,
    error: Boolean(error),
    success: success,
    ...
    __self: this
  }, "Create your own coin record:")), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_12__["Form"].Group, {
    widths: "equal",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 143
...
/* harmony default export */ __webpack_exports__["default"] = (CreateCoin);

/***/ })

})
//# sourceMappingURL=createcoin.js.f6fab4ae891a8c5cab0b.hot-update.js.map