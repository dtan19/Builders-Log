...
function CreateOrder(_id, user) {
  ...
  function handleChange(event) {
    var _event$target = event.target,
        ...
        selection = _event$target.selection,
    ...
    if (name === "media") {
      ...
      setStatus(function (prevState) {
        return _objectSpread({}, prevState, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])({}, name, selection));
      });
...
//# sourceMappingURL=createorder.js.f51ff4bb501e6f4bdc22.hot-update.js.map