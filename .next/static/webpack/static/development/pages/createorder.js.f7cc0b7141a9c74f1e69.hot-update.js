...
function CreateOrder(_id, user) {
  ...
  function handleSubmit(event) {
    var mediaUrl, url, _user, name, phone, email, notes, orderStatus, total, payload, response, orderId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _user = record.user, name = record.name, phone = record.phone, email = record.email, notes = record.notes, orderStatus = record.orderStatus, total = record.total;
            payload = {
              mediaUrl: mediaUrl,
              user: _user,
              name: name,
...
//# sourceMappingURL=createorder.js.f7cc0b7141a9c74f1e69.hot-update.js.map