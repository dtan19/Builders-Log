...
function CreateLog(_ref) {
  ...
  function handleSubmit(event) {
    var mediaUrl, url, date, hours, _amount, _logType, description, notes, payload, response, logId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            console.log(_id);
            date = log.date, hours = log.hours, _amount = log.amount, _logType = log.logType, description = log.description, notes = log.notes;
            payload = {
              mediaUrl: mediaUrl,
              date: date,
              hours: hours,
...
//# sourceMappingURL=createlog.js.f1820951350168a50bd0.hot-update.js.map