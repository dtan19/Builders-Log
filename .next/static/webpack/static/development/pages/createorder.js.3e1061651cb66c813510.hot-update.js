...
function CreateOrder(_id, user) {
  ...
  function handleSelect(event, data) {
    ...
    setRecord(function (prevState) {
      return _objectSpread({}, prevState, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])({}, orderStatus, data.value));
    });
    console.log(INITIAL_ORDER);
  }
  ...
  function handleSubmit(event) {
    var mediaUrl, url, name, phone, email, notes, _orderStatus, total, payload, response, orderId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            name = record.name, phone = record.phone, email = record.email, notes = record.notes, _orderStatus = record.orderStatus, total = record.total;
            payload = {
              mediaUrl: mediaUrl,
              name: name,
              phone: phone,
...
//# sourceMappingURL=createorder.js.3e1061651cb66c813510.hot-update.js.map