...
function CreateOrder(_id, user) {
  ...
  function handleSelect(event, data) {
    ...
    setRecord(function (prevState) {
      return _objectSpread({}, prevState, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])({}, data.name, data.value));
    });
    console.log(INITIAL_ORDER.data);
  }
...
//# sourceMappingURL=createorder.js.f94f64fda458a8f935c6.hot-update.js.map