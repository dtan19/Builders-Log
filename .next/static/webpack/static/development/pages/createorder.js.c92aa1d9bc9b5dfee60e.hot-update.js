...
function CreateOrder(_id, user) {
  ...
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_11___default.a.useState(''),
      ...
      mediaPreview = _React$useState2[0],
      setMediaPreview = _React$useState2[1];

  var _React$useState3 = react__WEBPACK_IMPORTED_MODULE_11___default.a.useState(false),
  ...
  var _React$useState7 = react__WEBPACK_IMPORTED_MODULE_11___default.a.useState(true),
  ...
  var _React$useState9 = react__WEBPACK_IMPORTED_MODULE_11___default.a.useState(''),
      ...
      setError = _React$useState10[1]; //const [status, setStatus] = React.useState(INITIAL_ORDER);
  ...
  function handleSelect(event, data) {
    ...
    console.log(data.value); //handleChange;

    setRecord(function (prevState) {
      return _objectSpread({}, prevState, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])({}, name, data.value));
    });
...
//# sourceMappingURL=createorder.js.c92aa1d9bc9b5dfee60e.hot-update.js.map