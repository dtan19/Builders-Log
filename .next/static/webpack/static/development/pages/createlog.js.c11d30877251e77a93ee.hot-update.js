...
function CreateLog(_ref) {
  ...
  function handleSubmit(event) {
    var mediaUrl, url, _user, date, hours, _amount, logType, description, notes, payload, response, logId;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            console.log(_id);
            _user = log.user, date = log.date, hours = log.hours, _amount = log.amount, logType = log.logType, description = log.description, notes = log.notes;
            payload = {
              mediaUrl: mediaUrl,
              user: _user,
              date: date,
...
//# sourceMappingURL=createlog.js.c11d30877251e77a93ee.hot-update.js.map