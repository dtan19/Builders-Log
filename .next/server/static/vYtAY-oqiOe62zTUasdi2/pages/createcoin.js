...
module.exports = __webpack_require__("J2lA");
...
function CreateCoin(_id, user) {
  const {
    0: record,
    1: setRecord
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(INITIAL_COIN);
  const {
    0: mediaPreview,
    1: setMediaPreview
  ...
  async function handleSubmit(event) {
    try {
      ...
      const url = `${_utils_baseUrl__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"]}/api/coin`;
      const {
        year,
        mint,
        era,
      ...
      next_router__WEBPACK_IMPORTED_MODULE_5___default.a.push(`/coin?_id=${coinId}`);
    } catch (error) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Header"], {
    ...
    name: "add",
    color: "orange"
  }), "Create a Coin Record"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Form"], {
    loading: loading,
    error: Boolean(error),
    success: success,
    ...
    centered: true,
    size: "small"
  }), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Form"].Group, null, __jsx("p", null, "Create your own coin record:")), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Form"].Group, {
    widths: "equal"
  }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Form"].Field, {
    control: semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Input"],
    name: "year",
