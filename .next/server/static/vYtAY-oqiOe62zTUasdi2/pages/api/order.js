...
async function handleGetRequest(req, res) {
  ...
  const order = await _models_Order__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOne({
    _id
  });
...
async function handlePostRequest(req, res) {
  ...
  try {
    ...
    const order = await new _models_Order__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]({
      name,
      phone,
      email,
      notes,
...
async function handleDeleteRequest(req, res) {
  ...
  await _models_Order__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOneAndDelete({
    _id
  });
  res.status(204).json({});
...
module.exports = __webpack_require__("02+D");
