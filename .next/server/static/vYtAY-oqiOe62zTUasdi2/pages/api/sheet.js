...
module.exports = __webpack_require__("9icG");
...
async function handleGetRequest(req, res) {
  ...
  const sheet = await _models_Sheet__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOne({
    _id
  });
...
async function handlePostRequest(req, res) {
  ...
  try {
    ...
    const sheet = await new _models_Sheet__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"]({
      name,
      columns,
      rows,
      mediaUrl
...
async function handleDeleteRequest(req, res) {
  ...
  await _models_Sheet__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].findOneAndDelete({
    _id
  });
  res.status(204).json({});
